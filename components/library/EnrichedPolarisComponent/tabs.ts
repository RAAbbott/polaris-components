...
const EnrichedPolarisComponent = `/* Nothing to see here... */`;

const EnrichedPolarisComponentCss = `/* If using CSS modules in Remix, make sure you have configured CSS bundling (https://remix.run/docs/en/main/styling/bundling) */
...
export const tabs: Tab[] = [
  ...
  { title: 'EnrichedPolarisComponent.jsx', content: EnrichedPolarisComponent },
  {
    title: 'EnrichedPolarisComponent.module.css',
    content: EnrichedPolarisComponentCss,
    lang: 'css'
  }
];
