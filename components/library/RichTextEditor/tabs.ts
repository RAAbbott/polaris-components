...
const Example = `import { BlockStack, Box, Card, Page, Text, SkeletonBodyText } from '@shopify/polaris';
...
Import is prevented by naming the RichTextEditor component RichTextEditor.client.jsx
...
export default function ExampleRemix() {
  const [textEditor1, setTextEditor1] = useState("");
