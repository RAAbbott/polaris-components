  ...
  return (
    <Page>
      <ReviewBanner
        ...
        onReview={(rating) => {
          console.log(rating);
          // redirect user to the review page, you can also record the rating in your analytics
        }}
        onClose={() => console.log('Review banner closed')}
      />
    </Page>
  );
}
...
export const tabs: Tab[] = [
  ...
  { title: 'ReviewBanner.jsx', content: ReviewBanner }
];
